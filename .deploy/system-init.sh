...
wget -qO /dev/stdout https://raw.githubusercontent.com/composer/getcomposer.org/2dce1a337ceed821c5e243bd54ca11b61e903a2a/web/installer | php -- --install-dir=/usr/local/bin --filename=composer
