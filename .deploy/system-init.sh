...
wget -qO /dev/stdout https://raw.githubusercontent.com/composer/getcomposer.org/eef6844b9e99f10a61001855cf833fc6eb382e2b/web/installer | php -- --install-dir=/usr/local/bin --filename=composer
