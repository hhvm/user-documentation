...
type Withdrawal =
  shape('trtype' => Bank, 'fromaccnum' => int, 'amount' => float);
type Transfer = shape(
  'trtype' => Bank,
  'fromaccnum' => int,
  'toaccnum' => int,
...
function main(): void {
  process_transaction(
    shape('trtype' => Bank::DEPOSIT, 'toaccnum' => 23456, 'amount' => 100.00),
  );
  process_transaction(shape(
    'trtype' => Bank::WITHDRAWAL,
    'fromaccnum' => 3157,
    'amount' => 100.00,
  ));
  process_transaction(shape(
    'trtype' => Bank::TRANSFER,
    'fromaccnum' => 23456,
    'toaccnum' => 3157,
    'amount' => 100.00,
  ));
