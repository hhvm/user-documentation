...
* With `AsyncMysqlClient`, we are able to take full advantage of [async](../../../async/intro.md) to perform other DB connection or I/O operations while waiting for this connection to return.
