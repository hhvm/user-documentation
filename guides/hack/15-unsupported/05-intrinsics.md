There are three main intrinsic expressions in PHP that are unsupported in Hack; that is, they are not typechecked in [partial mode](../17-typechecker/05-modes.md) and the typechecker errors in strict mode.
